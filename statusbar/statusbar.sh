...
print_gmail_unread() {
  gmail_unread="$(cat /home/stanleyc/.unreadmail | sed 2d)"
  echo -ne "\x05Ü\x04 Ó  ${gmail_unread}"
}

print_gmail2_unread() {
  gmail2_unread="$(cat /home/stanleyc/.unreadmail | sed 1d)"
  echo -ne "Ý Ó  ${gmail2_unread}"
}
...
# $(print_torrent_status) \
# $(print_gmail_unread) $(print_gmail2_unread) $(print_last_msg) \
# $(print_cpu_used) $(print_mem_used) \
# $(print_rx_rate) $(print_tx_rate) \
# $(print_volume) $(print_datetime) "

xsetroot -name "$(print_gmail_unread) $(print_gmail2_unread) $(print_last_msg) \
$(print_cpu_used) $(print_mem_used) \
$(print_rx_rate) $(print_tx_rate) \
$(print_volume) $(print_datetime) "
  # reset old rates
