...
/* appearance */
static const char font[]            = "-xos4-Terminus2-Medium-R-Normal--12-120-72-72-C-60-ISO8859-1";
#define NUMCOLORS 6
static const char colors[NUMCOLORS][ColLast][8] = {
  // border foreground background
  { "#073642", "#657b83", "#002b36" }, // 1 = normal (grey on black)
  { "#0E82C9", "#eee8d5", "#002b36" }, // 2 = selected (white on black)
...
/* tagging */
//ASCII 0xC0 - 0xC8
static const char *tags[] = { "À", "Â", "Ã", "Á",  "Ä", "Å", "Æ", "Ç", "È " };
